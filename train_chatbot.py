...
data_file = open("restaurants.json", encoding='UTF-8').read()
...
def train_chatbot_model(X, Y):
    ...
    model.save("./models/restaurants.h5", hist)
...
pickle.dump(vocab, open("./utils/restaurants_vocab.pkl", "wb"))
pickle.dump(classes, open("./utils/restaurants_classes.pkl", "wb"))
